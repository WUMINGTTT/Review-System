  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '创建评价', backTo: '/evaluations', backMode: 'back' },
      },
      {
        path: 'evaluations/:id',
        name: 'EvaluationDetail',
        component: () => import('../views/evaluations/Detail.vue'),
        meta: { title: '评价详情', backTo: '/evaluations', backMode: 'back', isDetail: true },
      },
      {
      ...
      },
      {
        ...
        name: 'EvaluationEdit',
        component: () => import('../views/evaluations/Create.vue'),
        meta: { title: '编辑评价', backTo: '/evaluations', backMode: 'back' },
      },
      {
        path: 'reviews',
        name: 'Reviews',
